...
analyzers_dir.mkdir(exist_ok=True)
feature_file = analyzers_dir / "feature_extractor.py"
feature_file.write_text(feature_extractor_code, encoding="utf-8")
print("✅ Создан analyzers/feature_extractor.py - умный переводчик данных!")
